...
function iconBlock(icon: string, iconColor: "navy" | "teal" | "gold" | "coral" = "teal", iconShape: "circle" | "square" = "circle") {
...
const reportCards = [
  {
    _key: "c1",
    content: [
      iconBlock("activity", "navy", "square"),
      ...
      statRow([
        ...
        { value: "$334", suffix: "*", suffixColor: "gold", label: "Industry avg" },
      ]),
  ...
  },
  {
    ...
    content: [
      ...
      divider("line"),
      statRow([
        { value: "94", suffix: "%", suffixColor: "teal", label: "Booking rate" },
        { value: "53", suffix: "%*", suffixColor: "gold", label: "Industry avg" },
      ]),
    ] as unknown as PortableTextBlock[],
  },
  {
    _key: "c3",
    content: [
      iconBlock("phone-off", "gold", "square"),
...
export const ThreeColumnReportCards: Story = {
  name: "3 Column — Report Cards (cream, bordered)",
  args: {
    value: {
      columns: 3,
      cardTheme: {
      ...
      items: [
        {
          _key: "c1",
          content: [
            iconBlock("bar-chart", "teal", "circle"),
            ...
            divider(),
            statRow([{ value: "94", suffix: "%", suffixColor: "teal", label: "Your practice" }]),
          ] as unknown as PortableTextBlock[],
        },
        {
          _key: "c2",
          content: [
            iconBlock("trending-up", "gold", "circle"),
    ...
    value: {
      ...
      items: [
        ...
        },
        {
          _key: "c2",
          content: [
            iconBlock("check-circle", "navy", "circle"),
        ...
        },
        {
          _key: "c3",
          content: [
            iconBlock("calendar", "gold", "circle"),
        ...
        },
        {
          _key: "c4",
          content: [
            iconBlock("dollar-sign", "teal", "circle"),
      ...
      items: [
        {
          _key: "c1",
          content: [
            iconBlock("activity", "teal", "circle"),
            block("cardCaption", "teal / circle"),
          ] as unknown as PortableTextBlock[],
        },
        {
          _key: "c2",
          content: [
            iconBlock("activity", "navy", "square"),
            block("cardCaption", "navy / square"),
          ] as unknown as PortableTextBlock[],
        },
        {
          _key: "c3",
          content: [
            iconBlock("activity", "gold", "circle"),
            block("cardCaption", "gold / circle"),
          ] as unknown as PortableTextBlock[],
        },
        {
          _key: "c4",
          content: [
            iconBlock("activity", "coral", "square"),
            block("cardCaption", "coral / square"),
          ] as unknown as PortableTextBlock[],
        },
      ],
    },
